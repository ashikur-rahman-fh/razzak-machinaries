...
from follow_ups.exceptions import (
    ARCHIVED_CUSTOMER_FOLLOW_UP_CODE,
    ARCHIVED_CUSTOMER_FOLLOW_UP_MESSAGE,
    FOLLOW_UP_NOT_ACTIONABLE_CODE,
    FOLLOW_UP_NOT_ACTIONABLE_MESSAGE,
    INVALID_FOLLOW_UP_DATE_CODE,
    INVALID_FOLLOW_UP_DATE_MESSAGE,
)
...
from halkhata.exceptions import (
    HALKHATA_CLOSED_CODE,
    HALKHATA_CLOSED_MESSAGE,
    HALKHATA_INVALID_PAYMENT_CODE,
    HALKHATA_INVALID_PAYMENT_MESSAGE,
    HALKHATA_INVITATION_INVALID_CUSTOMERS_CODE,
    HALKHATA_INVITATION_INVALID_CUSTOMERS_MESSAGE,
    HALKHATA_INVITATION_NO_CUSTOMERS_CODE,
...
SAFE_MESSAGES = {
    ...
    MUST_CHANGE_PASSWORD_CODE: MUST_CHANGE_PASSWORD_MESSAGE,
    TEMPORARY_PASSWORD_NOT_REQUIRED_CODE: TEMPORARY_PASSWORD_NOT_REQUIRED_MESSAGE,
    ...
    ARCHIVED_CUSTOMER_FOLLOW_UP_CODE: ARCHIVED_CUSTOMER_FOLLOW_UP_MESSAGE,
    INVALID_FOLLOW_UP_DATE_CODE: INVALID_FOLLOW_UP_DATE_MESSAGE,
    FOLLOW_UP_NOT_ACTIONABLE_CODE: FOLLOW_UP_NOT_ACTIONABLE_MESSAGE,
    HALKHATA_CLOSED_CODE: HALKHATA_CLOSED_MESSAGE,
    HALKHATA_INVALID_PAYMENT_CODE: HALKHATA_INVALID_PAYMENT_MESSAGE,
    HALKHATA_INVITATION_NO_CUSTOMERS_CODE: HALKHATA_INVITATION_NO_CUSTOMERS_MESSAGE,
    HALKHATA_INVITATION_INVALID_CUSTOMERS_CODE: HALKHATA_INVITATION_INVALID_CUSTOMERS_MESSAGE,
}
